        ...
        <div className="container flex h-16 items-center justify-between mx-auto px-4 md:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl tracking-tight hidden sm:flex items-center gap-2">
              Bidder Helper
              <span className="px-1.5 py-0.5 rounded text-[10px] uppercase font-bold bg-primary/20 text-primary border border-primary/30">AI</span>
            </span>
          </Link>
          <nav className="flex items-center gap-6">
            <Link href="/auth/login" className="text-sm font-medium text-muted-foreground hover:text-primary hover:drop-shadow-[0_0_8px_rgba(0,217,255,0.8)] transition-all">
              Sign In
            </Link>
            <Button asChild className="glow-btn bg-primary text-primary-foreground border-none">

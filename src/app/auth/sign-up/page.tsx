      ...
      <div className="flex-1 flex flex-col md:flex-row min-h-[calc(100vh-64px)]">
        <div className="hidden md:flex w-1/2 bg-card/20 border-r border-white/5 relative overflow-hidden flex-col justify-center p-12 lg:p-24">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold tracking-tight text-white">Join the platform.</h1>
            <p className="text-lg text-muted-foreground max-w-md font-light leading-relaxed">
              Create your account to start building your tailored application packages with our AI match engine.
            </p>
          </div>
        ...
        <div className="flex-1 flex items-center justify-center p-4 md:p-8 bg-background relative z-10">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center md:text-left space-y-2 md:hidden">
              ...
              <p className="text-muted-foreground text-sm">Start finding your perfect resume matches</p>
            </div>
              ...
              <form onSubmit={onSubmit} className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-xs font-mono text-muted-foreground uppercase tracking-wider">Full Name</Label>
                    <Input 
                      id="name" 
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email" className="text-xs font-mono text-muted-foreground uppercase tracking-wider">Email Address</Label>
                    <Input 
                      id="email" 
                      type="email" 
                ...
                <div className="pt-2">
                  <Button className="w-full h-12 text-sm font-bold glow-btn bg-primary text-primary-foreground border-none" type="submit" disabled={isLoading}>
